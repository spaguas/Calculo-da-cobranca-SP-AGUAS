...
if cobranca_selecionada == "Rural":
    with st.container(border=True):
        st.warning("⚠️ A cobrança para uso Rural ainda não é regulamentada por decreto no Estado de São Paulo. Esta simulação apresenta cenários hipotéticos, não uma cobrança real")
...
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#
# 7. Considerações sobre os coeficientes de cada bacia hidrográfica
#
...
#             |  Coeficientes que variam  |     Coeficientes Fixos    |  Coeficientes não usados  |#
# -------------------------------------------------------------------------------------------------#
# Captação	  |          X1, X5           |    X2, X3, X6, X7, X13    |        X4, X8-X12         |#
# Consumo	  |                 	      |     X1-X3, X5-X7, X13     |        X4, X8-X12         |#
...
#             |  Coeficientes que variam  |     Coeficientes Fixos    |  Coeficientes não usados  |#
# -------------------------------------------------------------------------------------------------#
# Captação	  |      X1, X3, X5, X7       |          X2, X13          |       X4, X6, X8-X12      |#
# Consumo	  |                 	      |    X1-X3, X6, X7, X13     |       X4, X5, X8-X12      |#
...
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 8. Seleção da função de cálculo de acordo com a bacia hidrográfica selecionada.
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
